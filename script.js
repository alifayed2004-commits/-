...
const VIDEOS = [
    ...
    { src: "video2.mp4.mp4", title: "فيديو 2" },
    { src: "video3.mp4.mp4", title: "فيديو 3" }
];

const PHOTOS = [
    { src: "love1.jpeg.jpeg", title: "صورة 1" },
    { src: "love2.jpeg.jpeg", title: "صورة 2" },
    { src: "love3.jpeg.jpeg", title: "صورة 3" }
];

const LOVE_LETTER = `يا حبيبت قلبي،

أولاً:كل سنة وانتي أجمل حاجه حصلتلي في حياتي، وجودك جنبي بقى

reason للسعادة والراحة، ومعاكي كل يوم بيعدي بيبقى أحلى من اللي قبله.

مش مجرد عيد ميلادك… ده اليوم اللي الدنيا كسبت فيه شخص زيك، شخص طيب وحنين وبيضحك قلبي من غير مجهود.

I love the way you make my life feel warm and safe.
وجودك بيخليني مهما أتعب أرجع أبتسم تاني.
my favorite place in the whole world وكأنك،
